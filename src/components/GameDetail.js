						...
						<Detail>
							<Stats>
								<div className="rating">
									<h3 layoutId={`title ${props.pathId}`}>{detail.game.name}</h3>
							...
							<Media>
								<img layoutId={`image ${props.pathId}`} src={get_smaller_image(detail.game.background_image, 1280)} alt={`Cover of ${detail.game.name}`} />
							</Media>
